...
CREATE TABLE `delivery_items` (
                                  ...
                                  `delivered_curior` tinyint(1) DEFAULT 0,
                                  `delivered_curior_date` date DEFAULT NULL,
                                  `order_date` date DEFAULT NULL,
                                  PRIMARY KEY (`flower_id`,`reference_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `delivery_items` VALUES
                                 ('670f8e5d133e3',3,2,'6713a8892db6d','672ddda0f2bb9',1,'2024-11-09','2024-10-10'),
                                 ('670f8e5d133e3',3,3,'6713b0a414cca',NULL,0,NULL,'2024-10-10'),
                                 ('670f8e5d133e3',3,3,'6713e1181e579','672ddda0f2bb9',1,'2024-11-09','2024-10-10'),
                                 ('670f8e5d133e3',3,11,'671488a110dcc','672ddda0f2bb9',1,'2024-11-09','2024-10-10'),
                                 ('670f8e5d133e3',3,1,'672648807d20e',NULL,0,NULL,'2024-10-12'),
                                 ('670f9f830fde0',3,3,'6713a8892db6d',NULL,0,NULL,'2024-10-10'),
                                 ('670f9f830fde0',3,1,'6713b0a414cca',NULL,0,NULL,'2024-10-10'),
                                 ('670f9f830fde0',3,2,'6713e1181e579',NULL,0,NULL,'2024-10-10'),
                                 ('670f9f830fde0',3,1,'67148b73a96ee',NULL,0,NULL,'2024-10-19'),
                                 ('670f9f830fde0',3,2,'672648807d20e',NULL,0,NULL,'2024-10-12');
...
INSERT INTO `employe` VALUES
    ('672ddda0f2bb9','thushan','thushanmadhusanka3@gmail.com','67215bebe2fe2737d90bb951347c6a0852a1f537',1,'2024-11-08');
...
INSERT INTO `flowers` VALUES
                          ('670f525cb03f3','aregasrg',46,560,'sergsrg',NULL),
                          ('670f8e5d133e3','rose',20,300,'dsfgasdfg',NULL),
                          ('670f8e72548f2','boganvilaaa',10,30,'sdhsresdfgsdgf',NULL),
                          ('670f9f830fde0','tulip',52,550,'svdsdvsdv',NULL);
...
INSERT INTO `orders` VALUES
                         (21,'2024-10-18','670f525cb03f3',46,1,1,'2024-11-03','2024-11-03',1,1200,560),
...
INSERT INTO `payments` VALUES
                           ...
                           ('672648807d20e',3,1710,'2024-11-02','73/jdfwe/u78mdf');
...
INSERT INTO `supliers` VALUES
                           ...
                           (4,'thushanfdf','Thushanmadusanka456@gmail.co','8f97b6291e2143261e962a3b949ff402a92d9b61',785914770,1),
                           (5,'erffddd','sdsd@mail.com','8cb2237d0679ca88db6464eac60da96345513964',993475633,0);
...
-- Dump completed on 2024-11-09 16:58:08